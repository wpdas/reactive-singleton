...
function useSingletonProps(singletonClass) {
    React.useContext(SingletonContext);
...
function useWasDataUpdated(singletonClass) {
    ...
    var _a = React.useState(false), hasUpdatedData = _a[0], setHasUpdatedData = _a[1];
    React.useEffect(function () {
...
exports.useSingletonStatus = useSingletonStatus;
exports.useWasDataUpdated = useWasDataUpdated;
