...
function useSingleton(singletonManager) {
    var singletonManagerStatus = useContext(SingletonContext).status;
...
export { Singleton, SingletonContext, SingletonManager, SingletonProvider, createSingleton, useSingleton };
